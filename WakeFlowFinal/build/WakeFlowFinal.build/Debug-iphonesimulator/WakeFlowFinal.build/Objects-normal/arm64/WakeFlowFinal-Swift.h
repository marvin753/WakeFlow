...
#ifndef WAKEFLOWFINAL_SWIFT_H
#define WAKEFLOWFINAL_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="WakeFlowFinal",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13WakeFlowFinal11AppDelegate")
...
@class NSString;
SWIFT_CLASS("_TtC13WakeFlowFinal22BackgroundAlarmManager")
@interface BackgroundAlarmManager : NSObject <AVAudioPlayerDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)observeValueForKeyPath:(NSString * _Nullable)keyPath ofObject:(id _Nullable)object change:(NSDictionary<NSKeyValueChangeKey, id> * _Nullable)change context:(void * _Nullable)context;
@end

SWIFT_CLASS("_TtC13WakeFlowFinal18SoundPreviewPlayer")
@interface SoundPreviewPlayer : NSObject <AVAudioPlayerDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
